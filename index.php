...
{
 $sql_query="DELETE FROM iotdata WHERE id=".$_GET['delete_id'];
 mysqli_query($con,$sql_query);
 header("Location: $_SERVER[PHP_SELF]");
}
if(isset($_GET['changestatus_id']))
{
 $sql_query="UPDATE iotdata SET `status`='".$_GET['status']."' WHERE id=".$_GET['changestatus_id'];
 mysqli_query($con,$sql_query);
 header("Location: $_SERVER[PHP_SELF]");
}
?>
...
function edt_id(id)
{
  window.location.href='edit_iotdata.php?edit_id='+id;
}
function view_id(id)
{
  window.location.href='view_iotdata.php?view_id='+id;
}
...
<div id="header">
 <div id="content">
    <label>ALPHA NUMERO - <a href="http://www.phpcodebuilder.com" target="_blank">IOT DASHBOARD</a></label>
    </div>
</div>
...
<div id="body">
 <div id="content">
    <table align="center">
    <tr>
    <th colspan="5"><a href="add_iotdata.php">add iotdata.</a></th>
    </tr>
    <th>SL NO</th>
    <th>temp</th>
